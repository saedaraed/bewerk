...
export default function TestimonialsSection() {
      ...
      const testimonials = t.raw("testi") as { name: string; image: string; rating: string; review: string;  }[];
  return (
    <section
    ...
    >
      <div className="relative flex flex-col items-center justify-center mb-14">
        <div className=" bg-[#1E1D1D] inline-block absolute z-10">
 ...
 <SwiperSlide className="rounded-[16px] p-8" key={index}>
          <div className="flex items-center gap-4">
            ...
            <h5 className="text-[16px] font-bold text-black">{testi.name}</h5>
          </div>
